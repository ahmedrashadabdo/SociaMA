package com.example.afnan.SociaMA.Search;
    ...
    private void initTextListener(){
        ...
        mSearchParam.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                searchForMatch(text);// searching users
                /*You should use Locale.getDefault() especially if you cant be sure that your text
                will always be in english. Also lint errors like that one you are having usually
                disappear after you run lint again or clean your project.*/
            }
        });
    }
