...
public class FollowingList extends AppCompatActivity {
    ...
    private Context mContext = FollowingList.this;
    ...
    private void updateUsersFollowingList(){
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra(getString(R.string.calling_activity), getString(R.string.following_list));
